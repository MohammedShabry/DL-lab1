...
Original file is located at
    https://colab.research.google.com/drive/1cifbNkta5EKyYEA5ZGCSFyV6VqURG9bw
"""
...
data = pd.read_csv('/content/drive/MyDrive/Data_Set/Au_nanoparticle_dataset.csv')  # Update path accordingly
